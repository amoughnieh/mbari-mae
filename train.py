...
# Train
dataset = SpectrogramDataset('final_project/data/spectrogram_chunks')
...
# Save the model
torch.save(model.state_dict(), 'final_project/marine_autoencoder.pth')
...
with torch.no_grad():
    ...
    plt.tight_layout()
    plt.savefig('final_project/data/marine_autoencoder_results.png', dpi=150)
    plt.show()